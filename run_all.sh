...
echo -e "\033[32mLoading Local modules...\033[0m"
...
echo -e "\033[35mRunning ReFrame ...\033[0m"
reframe -C ./config/local_config.py -c ./reframe/local_c/osu_local.py -r

echo -e "\033[32mLoading EasyBuild modules...\033[0m"
module purge
module load env/testing/2023b
...
echo -e "\033[32mLoading EESSI modules...\033[0m"
module purge
...
echo -e "\033[36mProduce plots\033[0m"
